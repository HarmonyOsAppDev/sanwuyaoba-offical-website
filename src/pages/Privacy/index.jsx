...
export default function PrivacyAgreement() {
    useEffect(() => {
        function showContent(language) {
            ...
            const engBtn = document.getElementById('showEnglish');
            const cnBtn = document.getElementById('showChinese');
            if (language === 'english') {
                englishContent.style.display = 'block';
                chineseContent.style.display = 'none';
    
                cnBtn.style.background = "white";
                cnBtn.style.color = "black";
                engBtn.style.background = "black";
                engBtn.style.color = "white";
            } else if (language === 'chinese') {
                englishContent.style.display = 'none';
                chineseContent.style.display = 'block';
    
                cnBtn.style.background = "black";
                cnBtn.style.color = "white";
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            if (userLang.startsWith('zh-CN')) {
                // If user's system language is Simplified Chinese
                showContent('chinese');
            } else {
    ...
    return (
        <div>
            <div class="language-toggle">
                <button id="showEnglish">English</button>
                <button id="showChinese">中文</button>
            </div>

            <div id="englishContent" class="content">
                <h1>Sanwu Planet Privacy Policy</h1>
                <section>
                    <h2>Introduction</h2>
            ...
            <div id="chineseContent" class="content">
                <h1>三五星球隐私政策</h1>
                <h2>引言</h2>
                <p>欢迎使用三五星球！我们重视用户的隐私和数据保护。本隐私政策旨在根据中国法律法规，透明地说明我们如何处理与您使用三五星球应用相关的信息。</p>
                ...
                <p>除上述必要功能外，我们不会主动收集其他个人信息。</p>

                <h2>第三方SDK</h2>
                <p>本应用集成了EasyAR SDK以提供增强现实功能。虽然我们自身服务不收集个人信息，但无法保证第三方SDK的数据收集行为。请参考EasyAR的隐私政策了解详情。</p>
                ...
                <p>数据安全存储在中国大陆境内的服务器上。</p>

                <h2>数据安全</h2>
                <p>我们采取适当的技术和管理措施保护用户信息，包括加密和访问控制。但请注意，任何互联网传输或存储系统都无法保证100%安全。</p>

                <h2>未成年人保护</h2>
                <p>根据《未成年人保护法》，14岁以下用户使用我们的服务需获得监护人同意。未经适当授权，我们不会故意收集未成年人的个人信息。</p>

                <h2>政策变更</h2>
                <p>我们可能根据业务实践或法律要求更新本隐私政策。变更后继续使用本应用即表示接受修订后的政策。</p>

                <h2>联系我们</h2>
                <p>如对本隐私政策有任何疑问，或希望行使中国法律赋予的权利，请联系深圳市三五幺发科技有限公司：hello@swyf.com</p>
            </div>
            </div>
    )
}