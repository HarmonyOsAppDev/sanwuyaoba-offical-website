    ...
    <div className="container">
      ...
      <div className="content" style={{ display: language === 'chinese' ? 'block' : 'none' }}>
        ...
        <section style={{ marginBottom: '20px' }}>
          ...
          <p>11.3 您理解并同意，在使用"知微宇宙"软件及相关服务过程中，我们使用了以下第三方 SDK：EasyAR SDK：用于提供增强现实（AR）功能，该 SDK 由视辰信息科技（上海）有限公司提供。使用该 SDK 时，可能会收集您的设备信息、相机权限等，具体隐私政策请参考 EasyAR 官方文档。(2) Unity SDK：用于提供游戏引擎和 3D 渲染功能，该 SDK 由 Unity Technologies 提供。使用该 SDK 时，可能会收集您的设备信息、使用数据等，具体隐私政策请参考 Unity 官方文档。</p>
        </section>
      ...
      <div className="content" style={{ display: language === 'english' ? 'block' : 'none' }}>
        <h1 style={{ fontSize: '24px', fontWeight: 'bold', marginBottom: '20px' }}>AstroPearl User Agreement</h1>
        
        <section style={{ marginBottom: '20px' }}>
          <h2 style={{ fontSize: '20px', fontWeight: 'bold', marginBottom: '10px' }}>1. Overview</h2>
          <p>Welcome to the "AstroPearl" software and related services! The "AstroPearl" software and related services refer to the client application program legally owned and operated by Shenzhen Sanwu Yaofa Technology Co., Ltd. (hereinafter referred to as "the Company") and the related website (http://sanwuyaoba.com/) that provides you with products and services, including but not limited to personalized audio and video recommendations, information publishing, interactive communication, search queries and other core functions.</p>
          <p>The "AstroPearl User Service Agreement" (hereinafter referred to as "this Agreement") is an agreement between you and the Company regarding your download, installation, registration, login, and use (hereinafter collectively referred to as "use") of the "AstroPearl" software and the related services provided by the "AstroPearl" software.</p>
          <p>In order to better serve you, please carefully read and fully understand this Agreement before starting to use the "AstroPearl" software and related services, especially the terms involving exemption or limitation of liability, license and information use, agreement to open and use special individual services, applicable law and dispute resolution, etc.</p>
          <p>If you are under 18 years old, please read this Agreement carefully and fully understand it with your legal guardian, and use the "AstroPearl" software and related services after obtaining the consent of your legal guardian.</p>
          <p>If you do not agree to this Agreement, this will prevent the Company from providing you with complete products and services, and you can also choose to stop using them. If you independently choose to agree or use the "AstroPearl" software and related services, it will be deemed that you have fully understood this Agreement and agree to be bound by this Agreement and other agreements and rules related to the "AstroPearl" software and related services (including but not limited to the "AstroPearl Privacy Policy") as a party to this Agreement.</p>
          <p>The Company has the right to unilaterally decide, arrange or designate its affiliates, controlling companies, successor companies or third-party companies approved by the Company to continue operating the "AstroPearl" software. Moreover, certain services under this Agreement may be provided to you by the Company's affiliates, controlling companies, successor companies or third-party companies approved by the Company. By knowing and agreeing to accept the relevant service content, you are deemed to accept that the relevant rights and obligations are also bound by this Agreement.</p>
          <p>If you have any questions, comments or suggestions about the content of this Agreement, you can contact the Company through the "Feedback and Help" page in the "AstroPearl" client or by sending an email to 3518@sanwuyaoba.com.</p>
        </section>

        <section style={{ marginBottom: '20px' }}>
          <h2 style={{ fontSize: '20px', fontWeight: 'bold', marginBottom: '10px' }}>2. "AstroPearl" Software and Related Services</h2>
          <p>2.1 You can obtain the "AstroPearl" client application program or access the AstroPearl related website through pre-installation, third-party downloads authorized by the Company, and other methods. If you obtain the "AstroPearl" software from sources other than the Company or its authorized third parties, the Company cannot guarantee that the unofficial version of the "AstroPearl" software will function normally, and the Company is not responsible for any losses you may suffer as a result.</p>
          ...
          <p>2.3 You can use the "AstroPearl" software and related services or update the "AstroPearl" version as needed. If you no longer need to use the "AstroPearl" software and related services, you can also uninstall the corresponding application software.</p>
          <p>2.4 To better enhance user experience and service, the Company will periodically provide updates or changes to the "AstroPearl" software and related services (including but not limited to software modifications, upgrades, feature enhancements, new service development, software replacement, etc.). You can choose whether to update to the corresponding version as needed. To ensure the security of the "AstroPearl" software and related services and improve user service, after the "AstroPearl" software and related services are partially or fully updated, the Company will notify you in an appropriate manner (including but not limited to system prompts, announcements, and in-app messages) when feasible. You have the right to choose to accept the updated version; if you choose not to update, some functions of the "AstroPearl" software and related services will be restricted or cannot be used normally.</p>
          <p>2.5 Unless you have obtained the Company's prior written authorization, you may not access or use the "AstroPearl" software and related services in any form, including but not limited to adaptation, copying, dissemination, vertical search, mirroring, or trading.</p>
          <p>2.6 You understand that you need to prepare the terminal equipment related to the software and related services (such as computers, mobile phones, and other devices) by yourself. Once you open the "AstroPearl" software on your terminal device or access the "AstroPearl" related website, it is deemed that you are using the "AstroPearl" software and related services. To fully realize all the functions of "AstroPearl," you may need to connect your terminal device to the internet. You understand that you should bear the necessary costs (such as data fees, internet fees, etc.) by yourself.</p>
          <p>2.7 The Company grants you a personal, revocable, non-transferable, non-exclusive, and non-commercial license to legally use the "AstroPearl" software and related services. All other rights not expressly authorized in this Agreement are still reserved by the Company. You must obtain the Company's written permission before exercising these rights. At the same time, if the Company does not exercise any of the foregoing rights, it does not constitute a waiver of that right.</p>
          <p>2.8 You need to register to start using the "AstroPearl" software and related services, but some functions or services may be affected. At the same time, you also understand that to better use the "AstroPearl" software and related services and protect your account security, certain functions and/or certain individual service items, such as comment services, require you to provide real identity information for real-name registration and login in accordance with relevant national laws and regulations before you can use them.</p>
          <p>2.9 If you find any content in the "AstroPearl" client or official website that infringes your rights, you can refer to the AstroPearl infringement complaint guidelines and notify the Company through the complaint channels prompted in the AstroPearl client, providing evidence of your relevant rights. The Company will handle your complaint in a timely manner in accordance with relevant legal regulations. If the content you publish on "AstroPearl" is complained of infringement by relevant rights holders and processed, and you do not agree with the processing results, you should submit a non-infringement statement and relevant rights proof materials to AstroPearl for appeal through the method prompted by the platform (in-app notification or 3518@sanwuyaoba.com). The Company will also handle your appeal in a timely manner in accordance with relevant legal regulations.</p>
        </section>

        <section style={{ marginBottom: '20px' }}>
          <h2 style={{ fontSize: '20px', fontWeight: 'bold', marginBottom: '10px' }}>3. About "Account"</h2>
          <p>3.1 After successful registration, users will have a AstroPearl account and corresponding password. The account password is the responsibility of the user to keep safe. At the same time, users have the right to use the account and shall bear legal responsibility for all activities and events conducted under the user account.</p>
          <p>3.2 When users log in, AstroPearl only verifies whether the user's verification code is correct and does not verify other user information. It does not bear responsibility for impersonation or verification behavior.</p>
          <p>3.3 You understand and promise that the account you set up must not violate national laws and regulations and relevant rules of "AstroPearl." Your account name, avatar, profile, and other registration information and personal information must not contain illegal or harmful information. You may not use others' names (including but not limited to impersonating others' names, titles, aliases, avatars, etc., or using other methods that may cause confusion) to create accounts without permission. You may not maliciously register "AstroPearl" accounts (including but not limited to frequent registration, batch registration of accounts, etc.). You must comply with relevant laws and regulations during account registration and use, and must not implement any acts that infringe on national interests, harm the legitimate rights and interests of other citizens, or harm social morality. The Company has the right to review the registration information you submit.</p>
          <p>3.4 Your registered account in "AstroPearl" is limited to your personal use. Without the Company's written consent, it is prohibited to gift, lend, rent, transfer, sell, or otherwise permit others to use the account in any form. If the Company discovers or has reasonable grounds to believe that the user is not the initial registrant of the account, to protect account security, the Company has the right to immediately suspend or terminate services to the registered account and may permanently disable the account.</p>
          <p>3.5 You are responsible for maintaining the security and confidentiality of your personal account and password, and shall bear all legal responsibilities for all activities conducted in the name of your registered account, including but not limited to any data modifications, comments, payments, and other operational behaviors you perform on the "AstroPearl" software and related services. You should attach great importance to the confidentiality of your account and password and not disclose your account and password to others under any circumstances. If you discover that others are using your account without permission or there are any other security vulnerabilities, you should immediately notify the Company.</p>
          <p>3.6 When registering, using, and managing your account, you should ensure the authenticity of the identity information filled in during account registration. Please use real, accurate, legal, and effective relevant identity certification materials and necessary information (including your name, email address, contact phone number, contact address, etc.) when registering and managing your account. In accordance with national laws and regulations, to use certain functions of the "AstroPearl" software and related services, you need to fill in real identity information. Please complete real-name authentication in accordance with relevant legal regulations and pay attention to updating the above relevant information in a timely manner. If the materials you submit or the information you provide is inaccurate, untrue, non-standard, illegal, or the Company has reason to suspect it is erroneous, untrue, or illegal, the Company has the right to refuse to provide you with relevant services, and you may not be able to use the "AstroPearl" software and related services or some functions may be restricted during use.</p>
          <p>3.7 After you complete the account registration, login, and reasonable and necessary identity verification for "AstroPearl," you can browse and use the relevant content and functions in the APP at any time. You understand and agree that for security and identity recognition considerations, you may not be able to modify the initial registration information and other verification information provided during registration. You can also apply to cancel your account. The Company will assist you in canceling your account after completing reasonable and necessary verification of personal identity, security status, device information, infringement complaints, etc., and will delete all information about your account in accordance with your requirements, except as otherwise provided by laws and regulations.</p>
        </section>
        ...
        <section style={{ marginBottom: '20px' }}>
          ...
          <p>Protecting user personal information is one of the Company's basic principles. In the process of using the "AstroPearl" software and related services, you may need to provide your personal information (including but not limited to your name, phone number, location information, device information, etc.) so that the Company can provide you with better services and corresponding technical support. The Company will legally protect your rights to browse, modify, delete relevant personal information, and withdraw authorization, and will use encryption technology, anonymization processing, and other technical measures and security measures that match the "AstroPearl" software and related services to protect your personal information.</p>
          <p>For more information about your personal information protection, please refer to the "AstroPearl Privacy Policy."</p>
        </section>

        <section style={{ marginBottom: '20px' }}>
          <h2 style={{ fontSize: '20px', fontWeight: 'bold', marginBottom: '10px' }}>5. User Behavior Standards</h2>
          <p>5.1 User Behavior Requirements</p>
          <p>You are responsible for your behavior in using the "AstroPearl" software and related services. Unless permitted by law or with the Company's prior written permission, you may not engage in the following behaviors when using the "AstroPearl" software and related services:</p>
          <p>5.1.1 Using any plugins, external programs, systems, or third-party tools that are not authorized or permitted by the Company to interfere with, damage, modify, or otherwise affect the normal operation of the "AstroPearl" software and related services.</p>
          <p>5.1.2 Using or targeting the "AstroPearl" software and related services to conduct any activities that endanger computer network security, including but not limited to:</p>
          ...
          <p>(6) Unauthorized attempts to probe, scan, or test the weaknesses of the "AstroPearl" system or network or other activities that damage network security;</p>
          <p>(7) Attempts to interfere with or damage the normal operation of the "AstroPearl" system or website, intentional dissemination of malicious programs or viruses, and other behaviors that destroy or interfere with normal network information services;</p>
          <p>(8) Forgery of TCP/IP data packet names or partial names;</p>
          <p>(9) Reverse engineering, reverse assembly, compilation, or other attempts to discover the source code of the "AstroPearl" software and related services;</p>
          <p>(10) Malicious registration of "AstroPearl" accounts, including but not limited to frequent and batch registration of accounts;</p>
        ...
        <section style={{ marginBottom: '20px' }}>
          ...
          <p>(24) Other information containing content that violates laws and regulations, policies, and public order and good customs, interferes with the normal operation of "AstroPearl," or infringes on the legitimate rights and interests of other users or third parties.</p>
        ...
        <section style={{ marginBottom: '20px' }}>
          <h2 style={{ fontSize: '20px', fontWeight: 'bold', marginBottom: '10px' }}>6. "AstroPearl" Information Content Usage Standards</h2>
          <p>6.1 Without the Company's written permission, no user or third party may independently or authorize, allow, or assist others to perform the following acts on the information content in the "AstroPearl" software and related services:</p>
          <p>(1) Copying, reading, or using the information content of the "AstroPearl" software and related services for commercial purposes, including but not limited to promotion, increasing readership, page views, etc.;</p>
          <p>(2) Unauthorized editing, organizing, or arranging the information content of the "AstroPearl" software and related services and displaying it on channels other than the source page of the "AstroPearl" software and related services;</p>
          <p>(3) Using any form of identification method, including but not limited to special identifiers, special codes, etc., to independently or assist third parties in generating traffic, readership guidance, transfer, hijacking, and other adverse effects on the information content of the "AstroPearl" software and related services;</p>
          <p>(4) Other acts of illegally obtaining or using the information content of the "AstroPearl" software and related services.</p>
          <p>6.2 Without the Company's written permission, no user or third party may directly or indirectly steal the video, graphic, and other information content of the "AstroPearl" software and related services in any way (including but not limited to hotlinking, redundant theft, illegal crawling, simulated downloading, deep linking, fake registration, etc.), or hide or modify domain rights management electronic information in any way.</p>
          <p>6.3 After obtaining the Company's written permission, users and third parties' sharing, forwarding, and other behaviors of the information content of the "AstroPearl" software and related services should also comply with the following standards:</p>
          ...
          <p>(2) No changes of any form may be made to the source webpage of the "AstroPearl" software and related services, including but not limited to the homepage links, advertising system links, and other entrances of the "AstroPearl" software and related services, nor may any form of obstruction, insertion, pop-up, or other interference be made to the display of the source page of the "AstroPearl" software and related services;</p>
          <p>(3) Safe, effective, and strict measures should be taken to prevent the information content of the "AstroPearl" software and related services from being illegally obtained by third parties through any form, including but not limited to "spider" programs;</p>
        ...
        <section style={{ marginBottom: '20px' }}>
          ...
          <p>7.3 The Company respects and protects the intellectual property rights, reputation rights, name rights, privacy rights, and other legitimate rights and interests of users and others. You guarantee that the text, pictures, videos, audio, links, etc. uploaded when using the "AstroPearl" software and related services do not infringe on any third party's intellectual property rights, reputation rights, name rights, privacy rights, and other rights and legitimate interests. Otherwise, the Company has the right to remove the suspected infringing content upon receiving notice from the rights holder or relevant party. For all rights claims raised by third parties, you shall handle them yourself and bear all possible legal responsibilities; if your infringing behavior causes losses to the Company and its affiliates, controlling companies, or successor companies (including but not limited to economic and reputational losses), you shall also fully compensate the Company and its affiliates, controlling companies, or successor companies for all losses suffered.</p>
        </section>

        <section style={{ marginBottom: '20px' }}>
          <h2 style={{ fontSize: '20px', fontWeight: 'bold', marginBottom: '10px' }}>8. Service Changes, Interruption, and Termination</h2>
          <p>8.1 You understand and agree that the "AstroPearl" software and related services provided by the Company are provided in their current state based on existing technology and conditions. The Company will make every effort to provide you with services and ensure the continuity and security of the services. You understand that the Company cannot always foresee and prevent legal, technical, and other risks, including but not limited to force majeure, network reasons, third-party service defects, third-party website reasons, etc., which may cause service interruption, inability to normally use the "AstroPearl" software and related services, and other losses and risks.</p>
          <p>8.2 You understand and agree that for the overall service operation and platform operation security needs, the Company has the right to decide on the settings of services/functions and their scope modification, interruption, suspension, or termination of the "AstroPearl" software and related services based on specific circumstances.</p>
        </section>

        <section style={{ marginBottom: '20px' }}>
          <h2 style={{ fontSize: '20px', fontWeight: 'bold', marginBottom: '10px' }}>9. Intellectual Property</h2>
          <p>9.1 The intellectual property rights of the content provided by the Company in the "AstroPearl" software and related services (including but not limited to software, technology, programs, web pages, text, pictures, images, audio, video, charts, layout design, electronic documents, etc.) belong to the Company. The copyright, patent rights, and other intellectual property rights of the software on which the Company provides "AstroPearl" and related services are all owned by the Company. Without the Company's permission, no one may use (including but not limited to monitoring, copying, disseminating, displaying, mirroring, uploading, downloading through any robots, "spiders," and other programs or devices) the content in the "AstroPearl" software and related services.</p>
          <p>9.2 The Company provides technical support for the development and operation of "AstroPearl" and enjoys all rights to all data and information generated during the development and operation of the "AstroPearl" software and related services within the scope permitted by laws and regulations.</p>
          <p>9.3 Please do not use the Company's trademarks, service marks, trade names, domain names, website names, or other distinctive brand features (hereinafter collectively referred to as "marks"), including but not limited to "AstroPearl" and "http://sanwuyaoba.com/," under any circumstances. Without the Company's prior written consent, you may not display, use, or apply for trademark registration, domain name registration, etc. of the aforementioned marks, either alone or in combination, nor may you implement behaviors that explicitly or implicitly indicate to others that you have the right to display, use, or otherwise handle these marks. If your use of the Company's above trademarks, marks, etc. in violation of this Agreement causes losses to the Company or others, you shall bear all legal responsibilities.</p>
        </section>

        <section style={{ marginBottom: '20px' }}>
          <h2 style={{ fontSize: '20px', fontWeight: 'bold', marginBottom: '10px' }}>10. Disclaimer</h2>
          <p>10.1 You understand and agree that the "AstroPearl" software and related services may be affected or interfered with by various factors. The Company does not guarantee (including but not limited to):</p>
          <p>10.1.1 The "AstroPearl" software and related services are completely suitable for your use requirements;</p>
          <p>10.1.2 The "AstroPearl" software and related services will not be interfered with, will be timely, secure, reliable, or error-free; any software, services, or other materials obtained by users from the Company meet users' expectations;</p>
          <p>10.1.3 Any errors in the "AstroPearl" software and related services will be corrected.</p>
          <p>10.2 You understand and agree that in the process of using the "AstroPearl" software and related services, you may encounter force majeure and other factors (force majeure refers to objective events that cannot be foreseen, overcome, and avoided), including but not limited to government actions, natural disasters (such as floods, earthquakes, typhoons, etc.), network reasons, wars, strikes, riots, etc. In the event of force majeure, the Company will strive to repair in a timely manner, but the Company is exempt from responsibility for any suspension, interruption, termination of services, or any losses caused by force majeure within the scope permitted by laws and regulations.</p>
          ...
          <p>10.4 You understand and agree: Regarding the "AstroPearl" software and related services, the Company does not provide any kind of express or implied guarantee or condition, including but not limited to merchantability, fitness for a particular purpose, etc. You should bear the corresponding risks for your use of the "AstroPearl" software and related services.</p>
          ...
          <p>10.6 In any case, the Company shall not be liable for any indirect, consequential, punitive, incidental, special, or penal damages, including profit losses suffered by you due to your use of the "AstroPearl" software and related services. Unless otherwise expressly provided by laws and regulations, the Company's total liability to you, regardless of the cause or manner of behavior, shall not exceed the fees you paid to the Company during your use of the "AstroPearl" software and related services (if any).</p>
        </section>
        ...
        <section style={{ marginBottom: '20px' }}>
          ...
          <p>11.1 The "AstroPearl" software and related services include information or information content links obtained by the Company through various legal means. These services may exist in "AstroPearl" in the form of separate sections. The Company has the right to add, reduce, or change the settings and services of these special sections from time to time.</p>
          <p>11.2 When you use software and related services provided by third parties in the "AstroPearl" software, in addition to complying with this Agreement and other relevant rules in the "AstroPearl" software, you may also need to agree to and comply with the third party's agreement and relevant rules. For disputes, losses, or damages arising from third-party software and related services, you shall resolve them with the third party yourself, and the Company does not bear any responsibility to you or any third party for this.</p>
          <p>11.3 You understand and agree that during the process of using the "AstroPearl" software and related services, we have used the following third-party SDKs: EasyAR SDK: For providing augmented reality (AR) functions, this SDK is provided by Shanghai Shichen Information Technology Co., Ltd. When using this SDK, we may collect your device information and camera permissions, please refer to the EasyAR official documentation for the specific privacy policy. (2) Unity SDK: For providing game engine and 3D rendering functions, this SDK is provided by Unity Technologies. When using this SDK, we may collect your device information and usage data, please refer to the Unity official documentation for the specific privacy policy.</p>
        </section>

        <section style={{ marginBottom: '20px' }}>
          <h2 style={{ fontSize: '20px', fontWeight: 'bold', marginBottom: '10px' }}>12. Minor Usage Terms</h2>
          <p>12.1 If you are a minor under 18 years old, you should carefully read and agree to this Agreement under the supervision and guidance of your guardian and with their consent before using the "AstroPearl" software and related services.</p>
          <p>12.2 The Company attaches great importance to the protection of minors' personal information. When filling in personal information, minor users should strengthen personal protection awareness and be cautious, and should correctly use the "AstroPearl" software and related services with the consent and under the guidance of their guardians.</p>
        ...
        <section style={{ marginBottom: '20px' }}>
          ...
          <p>13.2 To provide you with better services or due to changes in national laws and regulations, policies, technical conditions, product functions, etc., the Company will revise this Agreement from time to time, and the revised content constitutes part of this Agreement. After this Agreement is updated, the Company will issue an updated version in "AstroPearl" and notify you of the updated content through the official website (http://sanwuyaoba.com/) or other appropriate means before the updated terms take effect, so that you can timely understand the latest version of this Agreement. You can also check the latest version of the agreement terms on the website homepage or software settings page. If you continue to use the "AstroPearl" software and related services, it means that you have agreed to accept the revised content of this Agreement.</p>
          <p>If you have objections to the revised agreement content, please stop logging in or using the "AstroPearl" software and related services immediately. If you continue to log in or use the "AstroPearl" software and related services, it will be deemed that you recognize and accept the revised agreement content.</p>
